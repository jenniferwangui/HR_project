...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { department: @holiday.department, details: @holiday.details, endDate: @holiday.endDate, name: @holiday.name, phone: @holiday.phone, startDate: @holiday.startDate, type: @holiday.type }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { department: @holiday.department, details: @holiday.details, endDate: @holiday.endDate, name: @holiday.name, phone: @holiday.phone, startDate: @holiday.startDate, type: @holiday.type }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
